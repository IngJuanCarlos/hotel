  ...
  <ul class="sidebar-menu">
    <li class="treeview active">
      ...
      <ul class="treeview-menu">
        <li><a href="{{ url('/habitacion/mostrar') }}"><i class="fa fa-angle-double-right"></i> Rentar Habitación</a></li>
        <li class="active"><a href="{{ url('/habitacion/agregar') }}"><i class="fa fa-angle-double-right"></i> Agregar Habitación</a></li>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Agregar Habitación</h3>
              <!-- tools box -->
