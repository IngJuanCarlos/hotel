                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ asset('assets/sistema/img/avatar.png') }}" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                            Reviewers
    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active">
                    <a href="index.html">
                        <i class="fa fa-bookmark-o"></i> <span>Inicio</span>
                    </a>
                </li>
                <li>
...
<!-- Sparkline -->
<script src="{{ asset('assets/sistema/js/plugins/sparkline/jquery.sparkline.min.js') }}" type="text/javascript"></script>
<!-- jvectormap -->
<script src="{{ asset('assets/sistema/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/sistema/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}" type="text/javascript"></script>
<!-- fullCalendar -->
...
<!-- daterangepicker -->
<script src="{{ asset('assets/sistema/js/plugins/daterangepicker/daterangepicker.js') }}" type="text/javascript"></script>
<!-- Bootstrap WYSIHTML5 -->
